...
| System       | Build                                                                                                                                  | Test                                                                                                                                                                                          | Coverage                                                                                                                                           |
| :----------- | --------------------------------------------------------------------------------------------------------------------------------------:| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | -------------------------------------------------------------------------------------------------------------------------------------------------: |
| Unix         | [![Build Status](https://travis-ci.org/jxnet/Jxnet.svg?branch=master)](https://travis-ci.org/jxnet/Jxnet)                              | [![Build Status](https://dev.azure.com/ardikars/Jxnet/_apis/build/status/jxnet.Jxnet?branchName=master)](https://dev.azure.com/ardikars/Jxnet/_build/latest?definitionId=1&branchName=master) | [![Coverage Status](https://coveralls.io/repos/github/jxnet/Jxnet/badge.svg?branch=master)](https://coveralls.io/github/jxnet/Jxnet?branch=master) | 
| Windows      | [![Build status](https://ci.appveyor.com/api/projects/status/ev4t6t1ssacwj18j?svg=true)](https://ci.appveyor.com/project/jxnet/jxnet)  | [![Build Status](https://dev.azure.com/ardikars/Jxnet/_apis/build/status/jxnet.Jxnet?branchName=master)](https://dev.azure.com/ardikars/Jxnet/_build/latest?definitionId=1&branchName=master) | [![codecov](https://codecov.io/gh/jxnet/Jxnet/branch/master/graph/badge.svg)](https://codecov.io/gh/jxnet/Jxnet)                                   | 
